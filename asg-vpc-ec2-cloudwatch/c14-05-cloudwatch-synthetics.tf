...
#S3 bucket to store cannary logs
...
#Creating a canary synethetic CLoudwatch
...
#Create Cloudwatch alarm for caary or app availality less than 80%

resource "aws_cloudwatch_metric_alarm" "canary_cw_alarm" {
  alarm_name                = "app1-canary-cw-alarm"
  ...
  alarm_description = "This Synthetic alarm for app availability less than 80%"
